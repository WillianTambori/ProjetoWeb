    ...
    <h1>Cadastrado</h1>
        ...
        while($cliente = mysqli_fetch_assoc($listaCliente)){
            if($encontrado == $cliente['id']){
                ...
                echo "<img src='http://localhost/ProjetoWeb/processamento/".$cliente["foto"]."' height='100px' >";
        ...
        <section class="produto-produto" >
            ...
            <section class="produto-lista">
                ...
                while($produto = mysqli_fetch_assoc($listaProduto)){
                    if(login() == $produto["id"]){
                        echo"<div>";
                        echo "<img src='http://localhost/ProjetoWeb/processamento/".$produto["foto"]."' height='100px' >";
                        echo"<table>";
                        echo"<tr>";
                        echo"<th>Produto:</th>";
                        echo"</tr>";
